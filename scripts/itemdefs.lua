...
local newItems =
{
	...
	SC_item_router = util.extend( commondefs.item_template )
	{
		name = STRINGS.SCMODS_ITEMS.ITEMS.PORTABLE_ROUTER,
		desc = STRINGS.SCMODS_ITEMS.ITEMS.PORTABLE_ROUTER_TOOLTIP,
		flavor = STRINGS.SCMODS_ITEMS.ITEMS.PORTABLE_ROUTER_FLAVOR,
		...
		kanim = "kanim_laptop",
		ITEM_LIST = true,
		traits = { cooldown = 0, cooldownMax = 2, laptop = true, mainframe_icon_on_deploy = true, sightable = true, hidesInCover = true, cpus = 0, cpuTurn = 1, cpuTurnMax = 1, icebreak = 1 },
		requirements = { hacking = 4 },
		abilities = { "carryable", "deployable", "SC_router_icebreak" },
