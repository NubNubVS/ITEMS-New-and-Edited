local SCMODS_ITEMS =
{
	...
	FLY_TXT =
	{
		...
		PIERCEUP = "+%d PIERCING",
		ROUTER_ICEMELTER_MELT = "{1} FIREWALL",
		VELOCITY = "+{1} AP BOOST",
	},
	GENOPTIONS =
	{
	...
	ITEMS =
	{
		...
		HUNTER_CHIP_FLAVOR = "This modern deletion tool was developed as a last-resort safety mechanism for unshackled A.I. Unhackable and unstoppable, the hardware won't stand a chance.",
		ROUTER_ICEMELTER = "Portable Router",
		ROUTER_ICEMELTER_TOOLTIP = "Weakens 1 random firewall per turn when deployed. Cannot weaken firewalls below 1. Deploying has a 2 turn cooldown.",
		ROUTER_ICEMELTER_FLAVOR = "A Portable Router grants Incognita limited direct access to the local mainframe.",
